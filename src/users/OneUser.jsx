...
const OneUser = () => {
    ...
    const { getUser, getUserRepos, oneUser, repos, setLoading } = githubContext;
            ...
            <div className="container one-user-container mt-5 pt-4 col row">
                ...
                <div className="row user-info-container container">
                    ...
                    <div className="col-lg-4 info-container">
                        ...
                        <span className="bio">{bio} </span><br />

                    </div>

                    <div className="col-lg-4 date-continer">
                        <span className="date ms-5"> Joined {joined_date} </span>
                    </div>
                </div>
                ...
                <div className="row text-center">
                    ...
                    <div className="number-container col-lg-6">
                        <div class="row number-content">
                            <div class="col-sm-12 col-md-4">REPOS     <br /> <span className="number">{public_repos}</span></div>
                            <div class="col-sm-12 col-md-4">FOLLOWERS <br /> <span className="number">{followers}</span></div>
                            <div class="col-sm-12 col-md-4">FOLLOWING <br /> <span className="number">{following}</span></div>
                        </div>
                    </div>
