...
import profile from "../users/icons/profile.jpg";
          ...
          <div className="container about-app">
            <div className="row proj-about-row">
              ...
              <div className="col-sm-12 proj-content text-center">
                <h1>
                  {" "}
                  <span className="highlight">devfinder </span>
                  is a web application that lets you search a piece of github
                  developer information such as location, company, and their
